...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public void renewPassword(String userId, UserPasswordUpdateRequest request) {
    ...
    public Page<UserResponse> searchUsers(UserSearchRequest request, Pageable pageable) {
        ...
        Page<User> usersPage = userRepository.searchUsers(request, pageable);
    ...
    @Override
    @Transactional
    public UserResponse updateUserPassword(String userId, AdminPasswordUpdateRequest request) {
    ...
    @Override
    @Transactional
    public UserResponse toggleUserLock(String userId) {
